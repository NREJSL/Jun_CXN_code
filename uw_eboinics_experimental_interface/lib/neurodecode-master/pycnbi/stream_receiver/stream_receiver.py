            ...
            if len(streamInfos) > 0:
                ...
                for si in streamInfos:
                    ...
                    if 'USBamp' in amp_name:
                        ...
                        # self.multiplier = 10**-9 # change V -> uV unit for OpenVibe sources
                        break
                        ...
                        server_found = True
                        break
                    elif 'CXN_LSL' in amp_name:
                        logger.info('Found an CXN server %s (type %s, amp_serial %s) @ %s.' % (amp_name, si.type(), amp_serial, si.hostname()))
                        # ch_list = pu.lsl_channel_list(inlet)
                        # ch_list = ['P7', 'P4', 'Cz', 'Pz', 'P3', 'P8', 'O1', 'O2', 'T8', 'F8', 'C4', 'F4', 'Fp2', 'Fz',
                        #                'C3', 'F3', 'Fp1', 'T7', 'F7', 'Fpz', 'PO4', 'FC6', 'FC2', 'AF4', 'CP6', 'CP2', 'CP1',
                        #            'CP5', 'FC1', 'FC5', 'AF3', 'C1']
                        ch_list = ['C1','C2','C3','C4','C5','C6']  
                        self.channel_type = ['eeg', 'eeg', 'eeg', 'eeg', 'eeg', 'eeg']
                        # ch_list = ['P7', 'P4', 'Cz', 'Pz', 'P3', 'P8', 'EMG4', 'O2', 'T8', 'F8', 'C4', 'F4', 'Fp2', 'Fz', 'C3', 'F3', 'Fp1', 'T7', 'F7', 'C2', 'FC6', 'EMG2', 'FC2', 'EMG3', 'CP6', 'CP2', 'CP1', 'CP5', 'FC1', 'FC5', 'EMG1', 'C1']
                        # self._lsl_tr_channel = find_event_channel(ch_names=ch_list)
                        channels = len(ch_list)
                        amps.append(si)
                    ...
                    elif 'cognixion_raw_eeg' in amp_name:
                        logger.info('Found an COGNIXION server %s (type %s, amp_serial %s) @ %s.' % (amp_name, si.type(), amp_serial, si.hostname()))
                        # ch_list = pu.lsl_channel_list(inlet)
                        # ch_list = ['P7', 'P4', 'Cz', 'Pz', 'P3', 'P8', 'O1', 'O2', 'T8', 'F8', 'C4', 'F4', 'Fp2', 'Fz',
                        #                'C3', 'F3', 'Fp1', 'T7', 'F7', 'Fpz', 'PO4', 'FC6', 'FC2', 'AF4', 'CP6', 'CP2', 'CP1',
                        #            'CP5', 'FC1', 'FC5', 'AF3', 'C1']
                    ...
                    elif 'cognixion_classification' in amp_name:
                        logger.info('Found an lsl server %s (type %s, amp_serial %s) @ %s.' % (amp_name, si.type(), amp_serial, si.hostname()))
                        # ch_list = pu.lsl_channel_list(inlet)
                        # ch_list = ['P7', 'P4', 'Cz', 'Pz', 'P3', 'P8', 'O1', 'O2', 'T8', 'F8', 'C4', 'F4', 'Fp2', 'Fz',
                        #                'C3', 'F3', 'Fp1', 'T7', 'F7', 'Fpz', 'PO4', 'FC6', 'FC2', 'AF4', 'CP6', 'CP2', 'CP1',
                        #            'CP5', 'FC1', 'FC5', 'AF3', 'C1']
                        ...
                        server_found = True
                        break
                    elif 'cognixion_filtered_eeg' in amp_name:
                        logger.info('Found an CXN server %s (type %s, amp_serial %s) @ %s.' % (amp_name, si.type(), amp_serial, si.hostname()))
                        # ch_list = pu.lsl_channel_list(inlet)
                        # ch_list = ['P7', 'P4', 'Cz', 'Pz', 'P3', 'P8', 'O1', 'O2', 'T8', 'F8', 'C4', 'F4', 'Fp2', 'Fz',
                        #                'C3', 'F3', 'Fp1', 'T7', 'F7', 'Fpz', 'PO4', 'FC6', 'FC2', 'AF4', 'CP6', 'CP2', 'CP1',
...
# =============================================================================
    ...
    def acquire(self, string, blocking=True):
        """
        ...
        # print("len of timestamps: ", len(self.timestamps[0]))
        ...
        if timestamp_offset is True:
            ...
            logger.info('local timestamp = %s' %timestamp)
        ...
        # print("len of buffers: ", len(self.buffers[0]))
